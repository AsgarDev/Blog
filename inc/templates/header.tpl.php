...
<body>
  ...
  <header>
    ...
    <nav class="navbar navbar-expand-md navbar-light">
      ...
      <!-- TODO: dynamiser les liens vers les catégories -->
        <ul class="navbar-nav ">
          <?php 
            // $categoryId et $categoryName sont ici des DECLARATIONS
            foreach($categoryList as $categoryId => $categoryObject) : 
          ?>
          <li class="nav-item">
            <a class="nav-link" href="index.php?page=category&categoryId=<?= $categoryId ?>"><?= $categoryObject->name ?></a>
          </li>
          <?php endforeach; ?>
        </ul>
      </div>
